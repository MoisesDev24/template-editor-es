...
<head>
    ...
    <style>
        ...
        .btn_welcome {
            border: 2px solid <?php echo $colorP; ?>;
            color: <?php echo $colorP; ?>;
        }

        .btn_welcome:hover {
            background-color: <?php echo $fondoP; ?>;
        }
        ...
        .navbar_item > a {
            color: <?php echo $colorNegro; ?>;
        }

        .navbar_item > a:hover {
            background-color: <?php echo $colorNegro; ?>;
        }
        ...
        .boton_ver_mas {
            background-color: <?php echo $fondoS; ?>;
        }

        .boton_ver_mas:hover {
            border-color: <?php echo $bordeS; ?>;
    ...
    <style>
        .contenedor_form_buscador {
            background: <?php echo $fondoP; ?>;
        }
        
        .form_buscador:hover,
        .form_buscador:valid {
            border: 1px solid <?php echo $colorP; ?>;
        }

        #clear-btn:hover > svg {
            fill: <?php echo $colorP; ?>;
        }
        ...
        .btn_detalles:hover {
            border: 1px solid <?php echo $bordeS; ?>;
            color: <?php echo $colorS; ?>;
        }
        ...
        .btn_render_product {
            border: 2px solid <?php echo $bordeS; ?>;
            background-color: <?php echo $fondoS; ?>;
        }
    ...
    <style>
        model-viewer {
            ...
            --mv-exposure: 1; /* Ajustar si es necesario para controlar la exposición */
...
<body>
        ...
        <header class="cabecera">
            <nav class="navbar" id="navbar">
                <div class="navbar_contenedor_uno">
                    <?php
                        if (!empty($datos_plantilla['logo_t'])) {
                            ...
                            echo '
                                <a href="https://plataforma.kalstein.net/template-editor/assets/vistas/datosTienda.php" class="btn_inicio_2 efecto_edit" title="Agrega tu Logo aquí">
                                    <figure class="navbar_img">
                ...
                <div class="navbar_contenedor_dos">
                    <ul class="navbar_lista">
                        <li class="navbar_item"><a href="#" class="btn_inicio"><span>Tienda</span></a></li>
                        <li class="navbar_item"><a href="#" class="btn_productos"><span>Productos</span></a></li>
                    </ul>
                </div>
                ...
                <div class="modal_dropdown">
                    <div class="dropdown">
                        <ul class="dropdown_lista">
                            <li class="navbar_item_drop"><a href="#" class="btn_inicio"><span>Tienda</span></a></li>
                            <li class="navbar_item_drop"><a href="#" class="btn_productos"><span>Productos</span></a></li>
                        </ul>
                    </div>
                    <svg class="btn_cerrar_menu" xmlns="http://www.w3.org/2000/svg" height="35" width="35" viewBox="0 0 384 512">
            ...
            <div class="contenedor_form_buscador">
                <form action="" method="GET" class="form_buscador formulario_ajax">
                    <input type="search" name="buscador" placeholder="Busca por referencia, catalogo, producto, palabra clave o marca..." class="buscador_input" required>
                ...
                <figure class="banner_img">
                    <?php
                        if (!empty($datos_plantilla['titulo_t']) && empty($datos_plantilla['banner_t'])) {
                            ...
                            echo '
                                <a href="https://plataforma.kalstein.net/template-editor/assets/vistas/imagenes.php#banner_p" class="efecto_edit" title="Agrega un Banner aquí">
                                    <h1 class="titulo_principal" style="color: ' . (isset($color_p) ? $color_p : 'var(--color-primario)') . ';">
                                        Título de la Tienda
                                    </h1>
                                    <img src="../img/banner-2.png" alt="Banner">
        ...
        <main class="contenedor_principal">
            ...
            <?php
                if (isset($datos_plantilla['titulo_t']) && !empty($datos_plantilla['titulo_t'])) {
                    ...
                    echo '
                        <a href="https://plataforma.kalstein.net/template-editor/assets/vistas/datosTienda.php#descripcion_tienda" class="btn_contenedor_tienda" title="Agrega un Título y una Descripción aquí">
            ...
            <h2 class="titulo_secundario" id="marcador_productos">
                ¡Conoce nuestros <strong style="color: <?php if(isset($color_p)){echo $color_p;}else{echo 'var(--color-primario)';} ?>;">Productos</strong>!
            </h2>
                    ...
                    if(mysqli_num_rows($consulta_productos_limit) > 0) {
                        while ($datos_producto_limit = mysqli_fetch_array($consulta_productos_limit)) { 
                                ...
                                <div class="item_doble elementoScroll">
                                    <a href="#" class="item_doble_enlace btn_productos">
                                        <figure class="item_doble_img">
                                            <img src="'.$datos_producto_limit["product_image"].'" alt="'.$datos_producto_limit["product_name_es"].'">
                                        </figure>
                                    </a>
                            ...
                            ';
                                ...
                                $nombre_producto = $datos_producto_limit["product_name_es"];
                                ...
                                $descripcion = $datos_producto_limit["product_description_es"];
                        ...
                        echo '
                            <div class="item_doble elementoScroll">
                                <a href="https://plataforma.kalstein.net/distribuidor/productos/agregar/" class="item_doble_enlace efecto_edit" title="Agrega un Producto aquí">
                                    <figure class="item_doble_img">
                                ...
                                <div class="item_informacion">
                                    <a href="https://plataforma.kalstein.net/distribuidor/productos/agregar/" class="efecto_edit" title="Agrega un Producto aquí">
                                        <h2>Producto 1</h2>
                                    </a>
                                    ...
                                    <div class="separador_boton_precio">
                                        <a href="https://plataforma.kalstein.net/distribuidor/productos/agregar/" class="boton_ver_mas">
                                            Agregar
                    ...
                    if (mysqli_num_rows($consulta_prod_indiv) > 0) {
                                ...
                                <div class="item_individual elementoScroll">
                                    ...
                                    <a href="#" class="item_individual_enlace btn_productos">
                                        <figure class="item_individual_img">
                                            <img src="'.$datos_prod_indiv["product_image"].'" alt="'.$datos_prod_indiv["product_name_es"].'">
                                        </figure>
                                    </a>
                                </div>
                            ';
                        ...
                        echo '
                            <div class="item_individual elementoScroll">
                                <div class="item_informacion_individual">
                                    <div>
                                        <a href="https://plataforma.kalstein.net/distribuidor/productos/agregar/" class="btn_agg_prod efecto_edit" title="Agrega un Producto aquí">
                                            <h2>Producto 3</h2>
                                        </a>
                                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Inventore dolore accusamus esse itaque amet, aperiam quis delectus ut ipsum, officiis earum nobis adipisci, illum quas? Rem quis nemo eos hic.</p>
                                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Inventore dolore accusamus esse itaque amet, aperiam quis delectus ut ipsum, officiis earum nobis adipisci, illum quas? Rem quis nemo eos hic.</p>
                                ...
                                <a href="https://plataforma.kalstein.net/distribuidor/productos/agregar/" class="item_individual_enlace efecto_edit" title="Agrega un Producto aquí">
                                    <figure class="item_individual_img">
                                        <img src="../img/banner-default.png" alt="item">
                                    </figure>
                                </a>
                        ...
                        while ($datos_prod_limit = mysqli_fetch_array($consulta_prod_limit)) {
                            echo '
                                <div class="item_doble elementoScroll">
                                    <a href="#" class="item_doble_enlace btn_productos">
                                        <figure class="item_doble_img">
                                            <img src="'.$datos_prod_limit["product_image"].'" alt="'.$datos_prod_limit["product_name_es"].'">
                                        </figure>
                                    </a>
                    
                                    <div class="item_informacion">
                                        <h2>'.acortarNombre($datos_prod_limit["product_name_es"]).'</h2>';
                    
                                        // Obtener la descripcion y truncarla si excede el limite de caracteres
                                        $descripcionDos = $datos_prod_limit["product_description_es"];
                                        $limite_caracteres = 190;
            ...
            <h2 class="titulo_secundario">
                Carrusel de <strong style="color: <?php if(isset($color_p)){echo $color_p;}else{echo 'var(--color-primario)';} ?>;">Productos</strong>
            </h2>
                ...
                <div class="carousel_wrapper">
                    <?php
                        if (mysqli_num_rows($consulta_productos_img) > 0) {
                            ...
                            echo '
                                <a href="https://plataforma.kalstein.net/distribuidor/productos/agregar/" class="carousel_contenedor_imagen efecto_edit" title="Agrega un Producto aquí">
                                    <figure>
            ...
            <h2 class="titulo_secundario fondo_titulo">
                <?php
                    if (isset($datos_plantilla['subtitulo_t']) && !empty($datos_plantilla['subtitulo_t'])) {
                        ...
                        echo '
                            <a href="https://plataforma.kalstein.net/template-editor/assets/vistas/datosTienda.php#subtitulo_tienda" class="btn_titulo_tienda efecto_edit" title="Agrega un Subtítulo aquí">
                                ¡Título Secundario de tu Tienda!
                            </a>
                        ';
                    } else {
                        echo '¡Título Secundario de tu Tienda!';
                    }
                ?>
            </h2>
                    ...
                    if (mysqli_num_rows($consulta_productos_img_dos) > 0) {
                        ...
                        echo '
                            ...
                            <div class="contenedor_img_individual">
                                ...
                                <a href="https://plataforma.kalstein.net/distribuidor/productos/agregar/" class="img_individual_enlace" title="Agrega un Producto aquí">
                                    Agregar
                                    <svg class="icono_ver_mas-white" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 448 512">
                                        <path d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z"/>
                                    </svg>
            ...
            <div class="contenedor_info">
                <h2 class="titulo_secundario">
                    Información de la <strong style="color: <?php if(isset($color_p)){echo $color_p;}else{echo 'var(--color-primario)';} ?>;">Empresa</strong>
                </h2>
                ...
                <div class="historia elementoScroll">
                    <?php
                        if (isset($datos_plantilla['quienes_somos_t']) && !empty($datos_plantilla['quienes_somos_t'])) {
                            ...
                            echo '
                                <a href="https://plataforma.kalstein.net/template-editor/assets/vistas/datosTienda.php#quienes_somos" class="btn_contenedor_tienda_dos" title="Agrega tu Identidad Empresarial aquí">
                    ...
                    <figure class="historia_img">
                        <?php
                            if (!empty($datos_plantilla['img_quienes_s'])) {
                                ...
                                echo '
                                    <a href="https://plataforma.kalstein.net/template-editor/assets/vistas/imagenes.php#quienes_somos_t" class="efecto_edit" title="Agrega una Imagen aquí">
                        ...
                        if (isset($datos_plantilla['mision']) && !empty($datos_plantilla['mision'])) {
                            echo '
                                <div class="mision_datos">
                                    <h2>Nuestra Misión Empresarial</h2>
                                    <p>'.$datos_plantilla['mision'].'</p>
                                </div>
                            ';
                        } elseif($tipo_usuario['account_rol_aid'] == 2 || $tipo_usuario['account_rol_aid'] == 3 || $tipo_usuario['account_rol_aid'] == 4) {
                            echo '
                                <a href="https://plataforma.kalstein.net/template-editor/assets/vistas/datosTienda.php#mision_tienda" class="btn_contenedor_tienda_dos" title="Agrega tu Misión Empresarial aquí">
                    ...
                    <figure class="mision_img">
                        <?php
                            if (!empty($datos_plantilla['img_mision'])) {
                                ...
                                echo '
                                    <a href="https://plataforma.kalstein.net/template-editor/assets/vistas/imagenes.php#mision_img" class="efecto_edit" title="Agrega una Imagen aquí">
                                        <img src="../img/banner-default.png" alt="imagen_empresa">
                                    </a>
                                ';
                            } else {
                        ...
                        if (isset($datos_plantilla['vision']) && !empty($datos_plantilla['vision'])) {
                            echo '
                                <div class="vision_datos">
                                    <h2>Nuestra Visión Empresarial</h2>
                                    <p>'.$datos_plantilla['vision'].'</p>
                                </div>
                            ';
                        } elseif($tipo_usuario['account_rol_aid'] == 2 || $tipo_usuario['account_rol_aid'] == 3 || $tipo_usuario['account_rol_aid'] == 4) {
                            echo '
                                <a href="https://plataforma.kalstein.net/template-editor/assets/vistas/datosTienda.php#vision_tienda" class="btn_contenedor_tienda_dos" title="Agrega tu Visión Empresarial aquí">
                    ...
                    <figure class="vision_img">
                        <?php
                            if (!empty($datos_plantilla['img_vision'])) {
                                ...
                                echo '
                                    <a href="https://plataforma.kalstein.net/template-editor/assets/vistas/imagenes.php#imagen_vision" class="efecto_edit" title="Agrega una Imagen aquí">
                                        <img src="../img/banner-default.png" alt="imagen_empresa">
                                    </a>
                                ';
                            } else {
    ...
    <div id="seccion_productos">
        ...
        <div class="contenedor_patron_css">
            <main class="contenedor_principal">
                <h1 class="titulo_extra">PRODUCTOS</h1>
                    ...
                    <?php
                        if (mysqli_num_rows($consulta_render_products) > 0) {
                            while ($datos_producto = mysqli_fetch_array($consulta_render_products)) {
                                $parrafos_descripcion_dos = explode("\n", $datos_producto["product_description_es"]);
                                $titulo_original = $datos_producto["product_name_es"];
                                    ...
                                    <div class="grid-item">
                                        <div class="contenedor_producto" id="producto'.$datos_producto["product_aid"].'">
                                            <figure class="producto_img">
                                                <img src="'.$datos_producto["product_image"].'" alt="'.$datos_producto["product_name_es"].'">
                                            </figure>
                                ...
                                ';
                                    ...
                                    if (!empty($datos_producto["resultado_renderP"])) {
                                        ...
                                        echo '
                                            <a href="https://plataforma.kalstein.net/template-editor/assets/vistas/products3d.php" class="btn_render_product btn_to_render">
                                                Renderiza este Producto en 3D
                                            </a>
                                        ';
                                    }
                                    ...
                                    if(!empty($datos_producto["product_technical_description_es"])) {
                                        echo '
                                                <h4>Características:</h4>
                                                <table class="p-prev-table">'.$datos_producto["product_technical_description_es"].'</table>
                                            ';
                                    } 
                                
                                echo '
                                                <div class="contenedor_boton_ver_mas">
                                                    <a href="https://plataforma.kalstein.net/account_redirect/?search='.$datos_producto["product_model"].'" class="boton_ver_mas btn_cotizar">
                                                        <span>Cotizar</span>
                                                        <svg class="icono_ver_mas" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 448 512">
                            ...
                            if($tipo_usuario['account_rol_aid'] == 2 || $tipo_usuario['account_rol_aid'] == 3 || $tipo_usuario['account_rol_aid'] == 4) {
                                echo '
                                    ...
                                    <a href="https://plataforma.kalstein.net/distribuidor/productos/agregar/" class="btn_agregar_producto" title="Agrega un Producto aquí">
                                        ¡Agrega un Producto!
                                    </a>
                                ';
                            } else {
                                echo '
                                    <script>
                                        window.location.replace("https://plataforma.kalstein.net/template-editor/assets/vistas/plantilla.php");
                                    </script>";
                                ';
                            }
                        } else {
